...
public class Bee extends GameFigure {
    ...
    int currentPath;
    int index;
    public BeeAnimStrategy animStrategy;
    public static int numberOfBees = 0;
    public static final int MAX_NUMBER_BEES = 8;
    ...
    public Bee(int x, int y, int i, int p){
        ...
        animStrategy = new BeeFlyingInAnim(this);
        ++numberOfBees;
    ...
    private void updateStates() {
        ...
        switch (state){
            ...
            case FLYING_IN_COMPLETE:
                animStrategy = new BeeFlyingInComplete(this);
